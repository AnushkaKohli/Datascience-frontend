const TopCompanies = () => {
    return (
        <div className="px-6 md:px-32 py-12 mb-10 lg:mb-24 bg-[#FFFCEA]">
            ...
            {/* Logos */}
            <div className="flex mt-8 overflow-hidden gap-x-6">
                <div className="bg-white rounded-3xl px-20 lg:px-28 py-8 lg:py-12 text-[#374957] font-semibold text-xl lg:text-3xl">Logo</div>
                <div className="bg-white rounded-3xl px-20 lg:px-28 py-8 lg:py-12 text-[#374957] font-semibold text-xl lg:text-3xl">Logo</div>
                <div className="bg-white rounded-3xl px-20 lg:px-28 py-8 lg:py-12 text-[#374957] font-semibold text-xl lg:text-3xl">Logo</div>
                <div className="bg-white rounded-3xl px-20 lg:px-28 py-8 lg:py-12 text-[#374957] font-semibold text-xl lg:text-3xl">Logo</div>
                <div className="bg-white rounded-3xl px-20 lg:px-28 py-8 lg:py-12 text-[#374957] font-semibold text-xl lg:text-3xl">Logo</div>
